...
def dataprocess():
    ## ref
    depth_a = []
    with open('./DOT simulation/lesion.csv', 'r', newline='', encoding='ISO-8859-1')as f0:
    ...
    '''
    with open('./DOT simulation/lesion.csv', 'r', newline='', encoding='ISO-8859-1') as f1:
...
def test_data():
    with open('./DOT simulation/test_lesion.csv', 'r', newline='', encoding='ISO-8859-1')as f2:
...
#    pattern = re.compile('.{5}\d*E.\d{1,2}')
    ...
    with open('./DOT simulation/test_lesion.csv', 'r', newline='', encoding='ISO-8859-1') as fts:
